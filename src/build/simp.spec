...
Requires: pupmod-simp-simp >= 2.0.0, pupmod-simp-simp < 4.0.0
...
Requires: simp-rsync >= 5.1.0-3.el7.centos, simp-rsync < 7.0.0
Requires: simp-rsync-clamav >= 5.1.0-3.el7.centos, simp-rsync-clamav < 7.0.0
...
Requires: pupmod-simp-jenkins >= 5.0.0-2016
